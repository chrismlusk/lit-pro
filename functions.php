...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            // Bootstrap
            wp_register_script('jquery.bootstrap', get_template_directory_uri() . '/js/bootstrap.js', array(), '3.3.5', true); // true = in_footer
        ...
        // If production
            ...
            // Bootstrap minify
            wp_register_script('jquery.bootstrap.min', get_template_directory_uri() . '/js/bootstrap.min.js', array(), '3.3.5', true);
...
function html5blank_styles()
{
    if (HTML5_DEBUG) {
        ...
        // Bootstrap CSS
        wp_register_style('bootstrapmin', get_template_directory_uri() . '/css/bootstrap.min.css', array(), '1.0');
        ...
        // Custom CSS
        wp_register_style('html5blankcssmin', get_template_directory_uri() . '/style.min.css', array(), '1.0');
...
function add_to_author_profile( $contactmethods ) {
    $contactmethods['twitter'] = 'Twitter <span class="description">(full URL)</span>';
    $contactmethods['facebook'] = 'Facebook <span class="description">(full URL)</span>';
    $contactmethods['staff-title'] = 'Staff Title';

    return $contactmethods;
}

// Get users in a custom order
function get_users_by_include( $args = array() ) {
    $users = get_users( $args );
    if( isset( $args['include'] ) ){
        $include = $args['include'];
        usort($users, function ($a, $b) use( $include ){
...
add_filter('user_contactmethods', 'add_to_author_profile', 10, 1); // Put social media links in user profiles
